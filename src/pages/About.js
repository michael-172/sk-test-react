          ...
          <Row className={styles.AboutWrapper}>
            <Col className={styles.firstCol}>
              ...
              <p>
                ...
                analytics Digital agencies are strategic and creative marketing
                agencies focused.
              </p>
            </Col>
            ...
            <Col className={styles.secondCol}>
              <Col className={styles.secondCol__text}>
                <h2>Our Vision</h2>
                <p>
                  We integrate systems and technologiy designed by our team with
                  the most advanced tech available to deliver more reliable and
                  efficint energy projects, our global platform is our strength
                </p>
              </Col>
